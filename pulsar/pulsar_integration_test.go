	...
	tests := []struct {
	...
	}{
		{
			...
			map[string]interface{}{
				...
				"name":                      "test",
				"use_tls":                   true,
				"tls_trust_certs_file_path": "/go/src/github.com/Shoothzj/pulsar-beat-output/certs/ca.cert.pem",
				"certificate_path":          "/go/src/github.com/Shoothzj/pulsar-beat-output/role/admin.cert.pem",
				"private_key_path":          "/go/src/github.com/Shoothzj/pulsar-beat-output/role/admin.key-pk8.pem",
			},
			"my-topic1",
